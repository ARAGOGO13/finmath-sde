...
//
// где:
//   μ (mu)   – коэффициент сноса (ожидаемая доходность актива)
//   σ (sigma) – волатильность (коэффициент диффузии)
//   W_t      – стандартное броуновское движение
//
// Процесс S_t описывает динамику цены актива в модели Блэка–Шоулза.
