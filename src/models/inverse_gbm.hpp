...
// =============================================================================
// Модель обратного геометрического броуновского движения (U = 1/S)
//
// Если S_t следует GBM с параметрами μ, σ, то процесс U_t = 1/S_t по лемме Ито
// удовлетворяет СДУ:
//   dU_t = (σ² - μ) U_t dt - σ U_t dW_t
//
// где:
//   μ (mu)   – исходный коэффициент сноса актива S
//   σ (sigma) – волатильность (не меняется)
//
// Класс предоставляет аналитические моменты U_t и методы симуляции как через
// обратное преобразование GBM, так и непосредственным решением СДУ для U.
// =============================================================================
